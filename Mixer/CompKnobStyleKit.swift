...
public class CompKnobStyleKit : NSObject {

    //// Drawing Methods

    @objc dynamic public class func drawCompKnobOne(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 124, height: 124), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.5) {
        ...
        //// Color Declarations
        let black = UIColor(red: 0.000, green: 0.500, blue: 0.800, alpha: 1.000)
        let shadowColor = UIColor(red: 0.000, green: 0.500, blue: 1.000, alpha: 1.000)
        ...
        let orange2 = UIColor(red: 0.002, green: 0.500, blue: 0.900, alpha: 1.000)
