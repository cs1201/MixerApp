...
public class FXKnobStyleKit : NSObject {
    ...
    @objc dynamic public class func drawKnobOne(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 124, height: 124), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.5) {
        ...
        //// Color Declarations
        let black = UIColor(red: 0.6000, green: 0.000, blue: 0.800, alpha: 1.000)
        let shadowColor = UIColor(red: 0.000, green: 1.000, blue: 0.000, alpha: 1.000)
        ...
        let orange2 = UIColor(red: 0.600, green: 0.000, blue: 0.800, alpha: 1.000)
